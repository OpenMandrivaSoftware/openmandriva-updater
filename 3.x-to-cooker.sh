...
dnf -y erase perl-URPM perl-RPMBDB perl-MDV-Packdrakeng perl-MDV-Distribconf perl
dnf --releasever=cooker --nogpgcheck --allowerasing --best --exclude gtksourceview --exclude akonadi-contacts distro-sync
dnf --releasever=cooker --nogpgcheck --allowerasing --best install perl
